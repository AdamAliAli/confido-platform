...
Production-oriented monorepo with a Next.js admin/editor, NestJS API, PostgreSQL, JWT authentication, role-based authorization, validation, and Docker/Nginx load balancing.
